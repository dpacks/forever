...
module.exports.create = function (config) {
  ...
  server.get('/.well-known/psa', (req, res) => {
    res.json({
      ...
      links: [{
        rel: 'https://archive.org/services/purl/purl/dweb/spec/pinning-service-account-api',
        title: 'dPack Accounts API',
        href: '/v1/accounts'
      }, {
        rel: 'https://archive.org/services/purl/purl/dweb/spec/pinning-service-dpacks-api',
        title: 'dPack API',
        href: '/v1/dpacks'
      }]
    })
